...
LMS_URL=oxatwo-learning.$BASE_URL
CMS_URL=oxatwo-studio.$BASE_URL
...
# config/versions.yml
CONFIGURATION_REPO=https://github.com/Oxa-Client2/edx-configuration.git
CONFIGURATION_VERSION=oxa/master.fic
PLATFORM_REPO=https://github.com/Oxa-Client2/edx-platform.git
